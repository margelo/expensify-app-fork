...
type MockLegendListProps<T> = {
    data?: T[];
    extraData?: unknown;
    renderItem?: (info: LegendListRenderItemProps<T>) => React.ReactElement | null;
...
function createDefaultProps() {
    const renderItem = ({item}: LegendListRenderItemProps<TestItem>) => (
...
describe('Table', () => {
    ...
    describe('row selection (shift+click)', () => {
        const renderSelectableRow = ({item, index}: LegendListRenderItemProps<TestItem>) => (
            <Table.Row
                interactive
                rowIndex={index}
