...
let mockLegendListProps: LegendListProps<TestItem> | undefined;
...
jest.mock('@components/LegendList', () => {
    ...
    return {
        __esModule: true,
        default: ReactLocal.forwardRef((props: LegendListProps<TestItem>, ref: React.Ref<{getState: typeof mockGetState}>) => {
