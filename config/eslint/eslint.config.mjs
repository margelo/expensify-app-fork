...
const restrictedImportPaths = [
    {
        ...
        message: "Use '@components/LegendList' instead.",
    },
    {
    ...
    },
    {
        ...
        message: [
            ...
            "For 'FlatList' and 'FlatListProps', please use '@components/LegendList' instead.",
    ...
    },
    {
        ...
        message: "Use '@components/LegendList' for lists, and 'PressableWithFeedback' and/or 'PressableWithoutFeedback' from '@components/Pressable' for pressable components.",
    },
    {
...
const restrictedImportPatterns = [
    {
        ...
        message: "Use '@components/LegendList' for lists or '@components/DraggableList' for reorderable lists.",
    },
    {
        group: [
            '@components/FlatList/FlatList',
            '@components/FlatList/FlatList/**',
            '@components/FlashList',
            '@components/FlashList/**',
        ],
        message: "Legacy list wrappers have been removed. Use '@components/LegendList' instead.",
    },
    {
        ...
        rules: {
            ...
            'no-restricted-syntax': [
                ...
                // These are the original rules from AirBnB's style guide, modified to allow for...of loops and for...in loops
                {
                    ...
                    message: "Use '@components/LegendList/AnimatedLegendList' for animated lists or '@components/LegendList' for plain lists.",
                },
                {
