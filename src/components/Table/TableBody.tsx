...
import type {LegendListRenderItemProps, ViewToken} from '@components/LegendList/types';
    ...
    return (
        ...
        >
            <LegendList<TableData>
                ...
                ListEmptyComponent={
                    shouldRenderEmptyStateInList ? <View style={[styles.flexGrow1, styles.justifyContentCenter]}>{emptyStateContent}</View> : ListEmptyComponent
                }
