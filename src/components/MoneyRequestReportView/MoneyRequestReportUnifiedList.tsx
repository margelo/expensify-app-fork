...
import type {LegendListRef, LegendListRenderItemProps, ViewToken as LegendListViewToken} from '@components/LegendList/types';
...
function MoneyRequestReportUnifiedList({
    ...
    const onViewableItemsChangedAdjusted = (info: {
        viewableItems: Array<LegendListViewToken<UnifiedListItem>>;
        changed: Array<LegendListViewToken<UnifiedListItem>>;
    }) => {
